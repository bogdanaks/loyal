...
export default function PrivacyPolicy() {
  ...
  const colThWidth = ((width - 32) / 4) * 1
  const colTrWidth = ((width - 32) / 4) * 3
    ...
    >
      ...
      <ScrollView>
        <View style={{ marginTop: 16, marginBottom: bottom }}>
          <View style={[styles.bigBlock, { marginTop: 0 }]}>
            ...
            <Text style={styles.paragraph}>
              ...
              данных и меры по обеспечению безопасности персональных данных, предпринимаемые Аксёнов
              Богдан Русланович (далее — Оператор).
            </Text>
            <View style={styles.list}>
              ...
              <Text>
                ...
                посетителях приложения &quot;Баллами Бизнес&quot;.
              </Text>
            </View>
          </View>
          <View style={styles.bigBlock}>
            <Text style={styles.title}>2. Основные понятия, используемые в Политике</Text>
            <View style={styles.list}>
              <Text>
              ...
              <Text>
                2.3. Приложение — совокупность графических и информационных материалов, а также
              ...
              <Text>
                ...
                определенному или определяемому Пользователю приложения &quot;Баллами Бизнес&quot;.
              </Text>
              <Text>
              ...
              <Text>
                2.10. Пользователь — любой посетитель приложения &quot;Баллами Бизнес&quot;.
              </Text>
              <Text>
          ...
          <View style={styles.bigBlock}>
            <Text style={styles.title}>3. Основные права и обязанности Оператора</Text>
            <View style={styles.list}>
              <Text>3.1. Оператор имеет право:</Text>
          ...
          <View style={styles.bigBlock}>
            ...
            <View style={styles.list}>
              <Text>4.1. Субъекты персональных данных имеют право:</Text>
              <View style={styles.liBlock}>
                <Text>
          ...
          <View style={styles.bigBlock}>
            <Text style={styles.title}>5. Принципы обработки персональных данных</Text>
            <View style={styles.list}>
              <Text>
          ...
          <View style={styles.bigBlock}>
            <Text style={styles.title}>6. Цели обработки персональных данных</Text>
            <View style={styles.table}>
              <View style={styles.row}>
                <View style={[styles.colTh, { width: colThWidth }]}>
                  <Text>Цель обработки</Text>
                </View>
                <View style={[styles.col, { width: colTrWidth }]}>
                  <Text>
                    предоставление доступа Пользователю к сервисам, информации и/или материалам,
                    содержащимся в приложении
                  </Text>
                </View>
              </View>
              <View style={styles.row}>
              ...
              <View style={styles.row}>
                <View style={[styles.colTh, { width: colThWidth }]}>
                  <Text>Виды обработки персональных данных</Text>
                </View>
                <View style={[styles.col, { width: colTrWidth }]}>
                  <Text>
                  ...
                  <Text>Отправка информационных писем на адрес электронной почты</Text>
                </View>
              </View>
            </View>
          </View>
          <View style={styles.bigBlock}>
            <Text style={styles.title}>7. Условия обработки персональных данных</Text>
            <View style={styles.list}>
              <Text>
          ...
          <View style={styles.bigBlock}>
            ...
            <View style={styles.list}>
              ...
              <Text>
                ...
                электронной почты Оператора info@ballami.ru с пометкой «Актуализация персональных
                данных».
              </Text>
              <Text>
                ...
                посредством электронной почты на электронный адрес Оператора info@ballami.ru с
          ...
          <View style={styles.bigBlock}>
            <Text style={styles.title}>10. Трансграничная передача персональных данных</Text>
            <View style={styles.list}>
              <Text>
          ...
          <View style={styles.bigBlock}>
            <Text style={styles.title}>11. Конфиденциальность персональных данных</Text>
            <Text style={styles.paragraph}>
          ...
          <View style={styles.bigBlock}>
            <Text style={styles.title}>12. Заключительные положения</Text>
            <View style={styles.list}>
              <Text>
                ...
                электронной почты info@ballami.ru.
              </Text>
              <Text>
              ...
              <Text>
                ...
                адресу https://ballami.ru/legal/privacy-policy.
              </Text>
            </View>
          </View>
