...
import { GiftIcon } from "shared/assets/icons/gift-icon"
  ...
  return (
    <View style={[styles.container, style]}>
      ...
      <View style={{ flex: 1, height: "100%" }}>
        ...
        <Text style={[styles.shopDesc, { color: theme.mutedForeground }]} numberOfLines={2}>
          {shopClient.shop.short_description}
        </Text>
        <View style={{ flexDirection: "row", gap: 6, justifyContent: "space-between" }}>
          <View style={[styles.bonusCounterDiv, { backgroundColor: theme.muted }]}>
            <View
              style={{
